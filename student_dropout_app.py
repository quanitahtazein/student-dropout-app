...
print("✅ Logistic Regression model trained and predictions saved!")
...
if uploaded_file:
    ...
    # ---------------------------
    # 4️⃣ Predict using Logistic Regression (default)
    # ---------------------------
    ...
    # ---------------------------
    # 5️⃣ Show Top 20 high-risk students
    # ---------------------------
